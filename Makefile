...
#    Updated: 2022/03/06 15:46:28 by sham             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
TRACE_SRCS = $(addprefix src/trace/, hit/hit.c hit/normal.c hit/hit_sphere.c hit/hit_plane.c ray/ray.c ray/phong_lighting.c)
